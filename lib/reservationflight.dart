...
import 'package:homepage/bottomsheet.dart';
                ...
                children: [
                  Column(
                    children: travelers.isNotEmpty
                        ? travelers
                        .map((traveler) => Text("${traveler['firstName']} ${traveler['lastName']}"))
                        .toList()
                        : [const Text("0/1 Traveller")],
                  ),
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      if (result != null) {
                        setState(() {
                          travelers.add(Map<String, String>.from(result)); // Append new traveler
                        });
                      }
                    },
                    ...
                    child: const Text("+ Add New Traveller"),
                  ),
                ],
              ),
              const SizedBox(height: 15),
                  ...
                  onPressed: () {
                    if (travelers.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Please add at least one traveler before proceeding.")),
                      );
                      return;
                    }
